 ...
 * {@link ContenedorFragment2.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ContenedorFragment2#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ContenedorFragment2 extends Fragment {
     ...
     * @return A new instance of fragment ContenedorFragment2.
     */
    // TODO: Rename and change types and number of parameters
    public static ContenedorFragment2 newInstance(String param1, String param2) {
        ContenedorFragment2 fragment = new ContenedorFragment2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        vista=inflater.inflate(R.layout.fragment_contenedor_fragment2, container, false);
    ...
    private void llenarViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new RedFragment(), "TEORIA");
        adapter.addFragment(new VideosinFragment(), "VIDEOS");
        adapter.addFragment(new FinFragment(), "FORMULAS");
